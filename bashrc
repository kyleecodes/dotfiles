...
ssh-port-forward() {
	...
	ssh -L "$1:localhost:$1" -N kyleef@kyleef.rtvision.com
}
...
# ssh aliases
alias ssh-vm='ssh -A kyleef@2620:9d:4000:72:136c:fa8:54b:9be1'
alias ssh-ws='ssh kyleef@kyleef.rtvision.com'
...
# pnpm
export PNPM_HOME="/home/kyleef/.local/share/pnpm"
case ":$PATH:" in
*":$PNPM_HOME:"*) ;;
